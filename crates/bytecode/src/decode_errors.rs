use crate::{eip7702::Eip7702DecodeError, eof::EofDecodeError, metadata::MetadataDecodeError};
use core::fmt::Debug;
use std::fmt;
...
impl From<MetadataDecodeError> for BytecodeDecodeError {
    fn from(error: MetadataDecodeError) -> Self {
        Self::Metadata(error)
    }
}
...
impl fmt::Display for BytecodeDecodeError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::Metadata(e) => fmt::Display::fmt(e, f),
        }
    }
}
